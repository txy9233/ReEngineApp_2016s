...
bool MyBOClass::IsColliding(MyBOClass* const a_pOther)
{
	...
	*/
	...
	//try to draw a plane perpendicular to that normal/parallel to the face between the two objects

	//try to draw a plane from the cross product of all edges in a with all edges in b
		
	//if a plane can be drawn that separates the two they are not colliding
